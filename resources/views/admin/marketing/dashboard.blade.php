                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <p class="font-14 mb-0">{{ __('Users') }} <br> {{ __('Purchased') }}
                                </p>
                            </div>
            ...
            <div class="col-md-3">
                <div class="card m-b-30 bg-secondary-rgba shadow-sm">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4>{{ filter_var($coupon_discount) }} {{ filter_var($currencies) }}</h4>
                                <p class="font-14 mb-0">{{ __('Coupon') }} <br>
                                    {{ __('Amount') }}
                                </p>
                                ...
                                <tbody>
                                    @foreach ($user_order_count as $value)
                                        <tr>
                                            ...
                                            <td>
                                                {{ filter_var($value->coupon_discount) }} {{ filter_var($currencies) }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
...
@section('scripts')
    ...
    <script>
        ...
        var options = {
            ...
            series: graph,
            labels: ['Courses', 'Packages', 'Live Streamings'],
            legend: {
                show: true,
                position: 'bottom'
            },
