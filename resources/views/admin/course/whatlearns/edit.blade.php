    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        ...
        <div class="card-body ml-2">
          <form autocomplete="off" id="demo-form" method="post" action="{{url('whatlearns/'.$cate->id)}}" data-parsley-validate class="form-horizontal form-label-left">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="col-md-12">
              <div class="d-none">
              ...
              <div class="col-md-12">
                ...
                <textarea name="detail" class="form-control" required>{!! $cate->detail !!}</textarea>
              </div>
              <br>
              <div class="col-md-12">
