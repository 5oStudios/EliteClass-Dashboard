                                ...
                                <tbody>
                                    ...
                                    @foreach ($quizes as $quiz)
                                        ...
                                        <tr>
                                            ...
                                            @if ($quiz->is_image == 1)
                                                <td><img src="{{ env('APP_URL') . '/files/images/' . $quiz->a }}"
                                                        width="50" alt=""></td>
                                                <td><img src="{{ env('APP_URL') . '/files/images/' . $quiz->b }}"
                                                        width="50" alt=""></td>
                                                <td><img src="{{ env('APP_URL') . '/files/images/' . $quiz->c }}"
                                                        width="50" alt=""></td>
                                                <td><img src="{{ env('APP_URL') . '/files/images/' . $quiz->d }}"
                                                        width="50" alt=""></td>
                                            @else
                                                <td>{{ $quiz->a }}</td>
                                                <td>{{ $quiz->b }}</td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="box box-primary">
                                                        <div class="panel panel-sum">
                                                            <div class="modal-body">
                                                                <form autocomplete="off" id="demo-form2" method="POST"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="col-md-12">
                                                                                <label
                                                                                    for="exampleInputTit1e">{{ __('adminstaticword.Question') }}:<sup
                                                                                        class="redstar">*</sup></label>
                                                                                <textarea name="question" rows="6" class="form-control" placeholder="{{ __('Enter Your Question') }}"
                                                                                    {{ $quiz->type == 'audio' || $quiz->type == 'image' ? 'required' : '' }}>
                                                                            ...
                                                                            @if ($quiz->type == null || $quiz->type == 'mcq' || $quiz->type == 'image')
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <select style="width: 100%"
                                                                                        ...
                                                                                        <option
                                                                                            {{ $quiz->answer == 'A' || $quiz->answer == 'a' ? 'selected' : '' }}
                                                                                            value="A">
                                                                                            {{ __('adminstaticword.A') }}
                                                                                        </option>
                                                                                        <option
                                                                                            {{ $quiz->answer == 'B' || $quiz->answer == 'b' ? 'selected' : '' }}
                                                                                            value="B">
                                                                                            {{ __('adminstaticword.B') }}
                                                                                        </option>
                                                                                        <option
                                                                                            {{ $quiz->answer == 'C' || $quiz->answer == 'c' ? 'selected' : '' }}
                                                                                            value="C">
                                                                                            {{ __('adminstaticword.C') }}
                                                                                        </option>
                                                                                        <option
                                                                                            {{ $quiz->answer == 'D' || $quiz->answer == 'd' ? 'selected' : '' }}
                                                                                            value="D">
                                                                                ...
                                                                                @else
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="input-group mb-3">
                                                                                            <div
                                                                                                ...
                                                                                                <span
                                                                                                    ...
                                                                                                    id="inputGroupFileAddonimage">{{ __('Upload') }}</span>
                                                                                            </div>
                                                                                            <div class="custom-file">
                                                                                                ...
                                                                                                <input type="file"
                                                                                                    ...
                                                                                                    aria-describedby="inputGroupFileAddonimage"
                                                                                                    accept="image/*">
                                                                                                <label
                                                                                                    class="custom-file-label"
                                                                                                    for="exampleInputimage">{{ __('Choose image file') }}
                                                                                        ...
                                                                                        <a class="btn w-100 btn-primary"
                                                                                            href="{{ env('APP_URL') . '/files/images/' . $quiz->a }}"
                                                                                            target="_blank">{{ __('clickToViewOriginalImage') }}</a>
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="input-group mb-3">
                                                                                            ...
                                                                                            <div class="custom-file">
                                                                                                ...
                                                                                                <label
                                                                                                    class="custom-file-label"
                                                                                                    for="exampleInputimage">{{ __('Choose image file') }}</label>
                                                                                            </div>
                                                                                        </div>
                                                                                        <a class="btn w-100 btn-primary"
                                                                                            href="{{ env('APP_URL') . '/files/images/' . $quiz->b }}"
                                                                                            target="_blank">{{ __('clickToViewOriginalImage') }}</a>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <a class="btn w-100 btn-primary"
                                                                                            href="{{ env('APP_URL') . '/files/images/' . $quiz->c }}"
                                                                                            target="_blank">{{ __('clickToViewOriginalImage') }}</a>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <a class="btn w-100 btn-primary"
                                                                                            href="{{ env('APP_URL') . '/files/images/' . $quiz->d }}"
                                                                                            target="_blank">{{ __('clickToViewOriginalImage') }}</a>
                                                                                    </div>
                                                                                @endif
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="col-md-12 question-audio-edit">
                                                                                    <label class="text-dark"
                                                                                        for="exampleInputAudio">{{ __('adminstaticword.Audio') }}:</label>
                                                                                    <div class="input-group mb-3">
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text"
                                                                                                id="inputGroupFileAddonAudio">{{ __('upload') }}</span>
                                                                                        </div>
                                                                                        <div class="custom-file">
                                                                                            <input type="file"
                                                                                                name="audio"
                                                                                                ...
                                                                                                aria-describedby="inputGroupFileAddonAudio"
                                                                                                accept="audio/*">
                                                                                            <label
                                                                                                class="custom-file-label"
                                                                                                for="exampleInputAudio">{{ __('Choose audio file') }}</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div id="audioPreviewDiv"
                                                                                    class="col-md-12 question-audio-preview question-audio"
                                                                                    style="display: none;">
                                                                                    <label
                                                                                        class="text-dark">{{ __('adminstaticword.newAudioPreview') }}:</label>
                                                                                    <audio controls
                                                                                        id="audioPreview"></audio>
                                                                                </div>
                                                                                <div id="audioPreviewDiv"
                                                                                    class="col-md-12 question-audio-preview question-audio-edit">
                                                                                    <label
                                                                                        class="text-dark">{{ __('adminstaticword.OriginalAudioPreview') }}:</label>
                                                                                    <audio
                                                                                        src="{{ env('APP_URL') . '/files/audio/' . $quiz->audio }}"
                                                                                        controls id="audioPreview"></audio>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="col-md-12 question-image-edit">
                                                                                    <label class="text-dark"
                                                                                        for="exampleInputimage">{{ __('adminstaticword.image') }}:</label>
                                                                                    <div class="input-group mb-3">
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text"
                                                                                                id="inputGroupFileAddonimage">{{ __('upload') }}</span>
                                                                                    ...
                                                                                    <label id="imageLabel"
                                                                                        for="imagePreview"
                                                                                        style="display: none;">{{ __('new image') }}</label>
                                                                                    <img id="imagePreview" src="#"
                                                                                        alt="Image Preview"
                                                                                        style="max-width: 100%; max-height: 200px; margin-top: 10px; display: none;">
                                                                                    <label
                                                                                        for="imagePreviewORG">{{ __('original image') }}</label>

                                                                                    <img id="imagePreviewORG"
                                                                                        src="{{ env('APP_URL') . '/files/images/' . $quiz->question_img }}"
                                                                                        alt="Image Preview"
                ...
                <div class="modal-content">
                    ...
                    <div class="box box-primary">
                        <div class="panel panel-sum">
                            <div class="modal-body">
                                <form autocomplete="off" id="demo-form2" method="post"
                                    action="{{ route('questions.store') }}" data-parsley-validate
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="col-md-12">
                                                <label for="exampleInputDetails">{{ __('adminstaticword.Type') }}:<sup
                                                        class="redstar">*</sup></label>
                                                <select id="questionType" style="width: 100%" name="type"
                                            ...
                                            <div class="col-md-12 question-title">
                                                <label for="exampleInputTit1e">{{ __('adminstaticword.Question') }}:<sup
                                                        class="redstar">*</sup></label>
                                                <textarea id="questionTitle" name="question" rows="6" class="form-control"
                                                    placeholder="{{ __('Enter Your Question') }}" required></textarea>
                                                <br>
                                                <button id="spaceBtn" type="button" class="btn btn-primary-rgba"
                                                    onclick="addSpecialChars()">Add Space</button>
                                            </div>
                                            ...
                                            <div id="audioPreviewDiv"
                                                ...
                                                style="display: none;">
                                                <label
                                                    class="text-dark">{{ __('adminstaticword.AudioPreview') }}:</label>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <input type="file" name="question_img"
                                                            class="custom-file-input" id="exampleInputimage"
                                        ...
                                        <div class="col-md-6 question-options">
                                            <div class="col-md-12">
                                                <label for="questionsType ">{{ __('questionsType') }}:<sup
                                                        class="redstar">*</sup></label>
                                                <select id="questionsType" style="width: 100%" name="is_image"
                                                    class="form-control select2">
                                                    <option value="#" disabled selected>
                                                        {{ __('please select Option') }}</option>
                                                    <option value="text">{{ __('text') }}</option>
                                                    <option value="image">{{ __('images') }}</option>

                                                </select>
                                            </div>
                                            <div id="textMCQs" style="display:none">
                                                <div class="col-md-12 ">
                                                    <label for="exampleInputDetails">{{ __('adminstaticword.AOption') }}
                                                        :<sup class="redstar">*</sup></label>
                                                    <input type="text" name="a" class="form-control texts"
                                                ...
                                                <div class="col-md-12 ">
                                                    <label for="exampleInputDetails">{{ __('adminstaticword.BOption') }}
                                                        :<sup class="redstar">*</sup></label>
                                                    <input type="text" name="b" class="form-control texts"
                                                ...
                                                <div class="col-md-12 ">
                                                    ...
                                                    <label for="exampleInputDetails">{{ __('adminstaticword.COption') }}
                                                        :<sup class="redstar">*</sup></label>
                                                    <input type="text" name="c" class="form-control texts"
                                                ...
                                                <div class="col-md-12 ">
                                                    ...
                                                    <label for="exampleInputDetails">{{ __('adminstaticword.DOption') }}
                                                        :<sup class="redstar">*</sup></label>
                                                    <input type="text" name="d" class="form-control texts"
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                            ...
                                                            <input type="file" name="a"
                                                                class="custom-file-input images" id="exampleInputimage"
                                                                aria-describedby="inputGroupFileAddonimage"
                                                                accept="image/*">
                                                            <label class="custom-file-label"
                                                                for="exampleInputimage">{{ __('Choose image file') }}</label>
