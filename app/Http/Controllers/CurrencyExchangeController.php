...
class CurrencyExchangeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'code.string' => __('Currency code must be a string'),
            'code.max' => __('Currency code should not be more than 3 characters'),
        ]);
    ...
    public function destroy($code)
    {
        ...
        {
            return back()->with('delete', __("You can't delete default currency"));
        }
