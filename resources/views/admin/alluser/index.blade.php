                        ...
                        <table id="allusertable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('adminstaticword.TestUser') }}</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            ...
                                            <p>{{ __('This process') }} <b>{{ __('delete') }}</b>
                                                {{ __('the user, Do you really want to delete the selected user? This process
                                                cannot be undo.') }}
                                            </p>
                                        </div>
...
<script type="text/javascript">
    $(function() {
        ...
        // console.log('RESP:: ', table.ajax.json());
    });
</script>
<script>
    ...
    $(document).on("change", ".test_user", function() {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: 'testusers/status',
            data: {
                'id': $(this).data('id'),
                'test_user': $(this).is(':checked') ? '1' : '0',
            },
            success: function(data) {
                var success = new PNotify({
                    title: 'success',
