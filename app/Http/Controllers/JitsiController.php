...
class JitsiController extends Controller {
    ...
    public function jitsicreate() {
        ...
        return view('admin.jitsimeeting.create', compact('course', 'category', 'users'));
    }
    ...
    public function savejitsimeeting(Request $request) {
        ...
        $jitsimeeting->price = $request->price;
        $jitsimeeting->discount_price = $request->discount_price;
        $jitsimeeting->main_category = !$course_id ? $request->main_category : null;
        $jitsimeeting->sub_category = !$course_id ? $request->sub_category : null;
        $jitsimeeting->ch_sub_category = !$course_id ? $request->ch_sub_category : null;
        $jitsimeeting->user_id = $request->user_id;
        $jitsimeeting->owner_id = $userid;
