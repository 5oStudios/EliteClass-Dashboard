<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
        ...
        @endcan
        @can('users.edit')
            <a class="dropdown-item" href="{{ route('testuser.edit', $id) }}"><i
                    class="feather icon-edit mr-2"></i>{{ __('Edit') }}</a>
        @endcan
        @if(auth()->user()->hasRole('admin'))
            <a class="dropdown-item" href="{{ route('testuser.enrollments', $id) }}"><i
                    class="feather icon-user-check mr-2"></i>{{ __('Enrollment') }}</a>
        @endif
        @can('users.delete')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>{{ __('This process') }} <b>{{ __('delete') }}</b>
                    {{ __('the user, Do you really want to delete') }}
                    <b>{{ $fname }}</b>?
