        ...
        <div class="col-md-3">
            ...
            <div class="card p-3 mb-5">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link" id="v-pills-Bunnycdn-tab" data-toggle="pill" href="#v-pills-Bunnycdn" role="tab" aria-controls="v-pills-Bunnycdn" aria-selected="false"><i class="feather icon-credit-card mr-2"></i>{{ __('BUNNYCDN API Keys') }}</a>
            ...
            {{ method_field('POST') }}
                <div class="card p-3">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-Bunnycdn" role="tabpanel" aria-labelledby="v-pills-Bunnycdn-tab">
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <label class="text-dark" for="s_enable">{{ __('BunnyCDN API Keys') }}</label>
                                </div>
                                    
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="BUNNYCDN_API_KEY">{{ __('BUNNYCDN_API_KEY') }} <span class="text-danger">*</span></label>
                                        <input value="{{ env('BUNNYCDN_API_KEY') }}" autofocus
                                            name="BUNNYCDN_API_KEY" type="text" class="form-control"
                                            placeholder="Enter bunnycdn api key" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="BUNNYCDN_LIBRARY_ID">{{ __('BunnyCDN LibraryID') }} <span class="text-danger">*</span></label>
                                        <input value="{{ env('BUNNYCDN_LIBRARY_ID') }}" autofocus
                                            name="BUNNYCDN_LIBRARY_ID" type="text" class="form-control"
                                            placeholder="Enter bunnycdn library id" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-dark" for="BUNNYCDN_HOSTNAME">{{ __('BunnyCDN Hostname') }} <span class="text-danger">*</span></label>
                                        <input value="{{ env('BUNNYCDN_HOSTNAME') }}" autofocus
                                            name="BUNNYCDN_HOSTNAME" type="text" class="form-control"
                                            placeholder="Enter bunnycdn hostname" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="BUNNYCDN_ZONE">{{ __('BunnyCDN Zone') }} </label>
                                        <input value="{{ env('BUNNYCDN_ZONE') }}" autofocus
                                            name="BUNNYCDN_ZONE" type="text" class="form-control"
                                            placeholder="Enter bunnycdn pull zone" />
