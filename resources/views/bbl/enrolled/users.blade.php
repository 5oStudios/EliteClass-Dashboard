...
@component('components.breadcumb',['secondaryactive' => 'active'])
    @slot('heading')
    {{ __('adminstaticword.UsersEnrolled'). __(" in")." [ ".$meeting->meetingname." ]" }}
    @endslot
    ...
    @slot('button')
        <div class="col-md-5 col-lg-5">
            <div class="widgetbar">
                <a href="{{ route('bbl.all.meeting') }}" class="float-right btn btn-primary-rgba mr-2"><i
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="enrolled-meeting-datatable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>#</th>
...
<script>
	$(function () {
        $('#enrolled-meeting-datatable').dataTable({
            language: {
