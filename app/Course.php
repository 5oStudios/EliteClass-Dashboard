...
class Course extends Model
{
    ...
    protected $fillable = [
        'category_id', 'scnd_category_id', 'subcategory_id', 'childcategory_id', 'language_id', 'user_id', 'title','short_detail', 'detail',  'price', 'discount_price',
        'day','video', 'video_url', 'iframe_url', 'featured','requirement','url','slug', 'start_date', 'end_date', 'status','preview_image',
        'type', 'preview_type', 'duration', 'duration_type', 'instructor_revenue', 'involvement_request', 
        'refund_policy_id', 'assignment_enable', 'appointment_enable', 'certificate_enable', 'course_tags',
        'level_tags', 'reject_txt', 'drip_enable', 'institude_id', 'country',
        'total_installments','installment_price','installment','credit_hours','wtsap_link'
    ];
