...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'switch_languages_api' => \App\Http\Middleware\LocalizationMiddleware::class,
        ...
        'basicAuth' => \App\Http\Middleware\BasicAuth::class, //Registered New Middleware
        'restrictFileAccess' => \App\Http\Middleware\RestrictFileAccess::class, //Registered New Middleware
        'allowFileDownloadOrPrint' => \App\Http\Middleware\allowFileDownloadOrPrint::class //Registered New Middleware
    ];
