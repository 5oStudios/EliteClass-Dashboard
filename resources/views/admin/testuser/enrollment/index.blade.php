...
@section('title', __('Test User Orders'))
...
@component('components.breadcumb',['secondaryactive' => 'active'])
    ...
    @slot('button')
        <div class="col-md-5 col-lg-5">
            <div class="widgetbar">
                <a href="{{ route('testuser.index') }}" class="float-right btn btn-danger-rgba mr-2"><i
                        class="feather icon-arrow-left mr-2"></i>{{ __('Back') }}</a>
                <a href="{{ route('manual.enrollment.create', ['test_user' => request()->id]) }}" class="float-right btn btn-primary-rgba mr-2"><i
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title"> {{ __('Test User Orders') }}</h5>
                </div>
                <div class="card-body">
                    <div class="row mr-5">
...
<script>
    $(function() {
        ...
        var table = $('#order-datatable').DataTable({
            ...
            ajax: {
                url: "{{ route('testuser.enrollments', request()->id) }}",
                type: 'GET',
            },
            ...
            columns: [
                ...
                {data: 'installments', name: 'orders.installments', visible: false},
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    var success = new PNotify( {
                        title: 'success', text: data.success, type: 'success', desktop: {
