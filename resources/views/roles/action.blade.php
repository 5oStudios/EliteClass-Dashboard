<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
    ...
    @if(in_array($id,['1','2','3']))
      <a class="dropdown-item"   href="{{ route('roles.show',$id) }}"><i class="feather icon-eye mr-2"></i>{{ __("View")}}</a>
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <p>{{__('Do you really want to delete this role')}} <b>{{ $name }}</b> ? <b> {{__("By Clicking YES IF any user attach to this role will be set user role !")}} </b>{{ __("This process cannot be undone") }}.</p>
      </div>
