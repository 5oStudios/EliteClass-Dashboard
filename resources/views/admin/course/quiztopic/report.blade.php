    ...
    @component('components.breadcumb', ['secondaryactive' => 'active'])
        ...
        @slot('button')
            <div class="col-md-5 col-lg-5">
                <a href="{{ url('course/create/' . $topics->courses->id) }}" class="float-right btn btn-primary-rgba"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        $last_attempt = \App\QuizAnswer::where('topic_id', $a->topic_id)
                                                            ->where('user_id', $a->user_id)
                                                            ->orderBy('attempt', 'desc')
                                                            ->first();
                                                        $answer = \App\QuizAnswer::where('topic_id', $a->topic_id)
                                                            ->where('user_id', $a->user_id)
                                                            ->where('attempt', $last_attempt->attempt)
                                                            ->get();
                                                        $mark = 0;
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('manual-grading/course/' . $a->course_id . '/topic/' . $a->topic_id . '/student/' . $a->user_id) }}"><i
