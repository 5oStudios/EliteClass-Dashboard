                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <h4>{{ $bbl }}</h4>
                                            <p class="font-14 mb-0">{{ __('BBL Live Streamings') }}</p>
                                        </div>
                                        @if (Route::has('bbl.setting'))
                                            <div class="col-6 text-right">
                                                <a href="{{ route('bbl.all.meeting') }}"><i
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6 text-right">
                                            <a href="{{ route('allinstructor.index') }}"><i
                                            ...
                                            <div class="user-slider-item">
                                                <div class="card-body text-center">
                                                    <span class="action-icon badge badge-primary-inverse"><img
                                                            src="{{ Avatar::create($topinstructors->fname)->toBase64() }}"
                                                ...
                                                <div class="card-body text-center">
                                                    <span class="action-icon badge badge-primary-inverse">
                                                        @if ($topcourse['preview_image'] !== null && $topcourse['preview_image'] !== '')
                                                            <img src="{{ asset('images/course/' . $topcourse['preview_image']) }}"
                                                                class="dashboard-imgs" alt="">
                                                        @else
                                                            <img src="{{ Avatar::create($topcourse->title)->toBase64() }}"
                                                                class="dashboard-imgs" alt="">
                                                        @endif
                                            ...
                                            <div class="user-slider">
                                                <div class="user-slider-item">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <p><span
                                                                class="badge badge-primary-inverse">{{ __('Price') }}:{{ $toporders->paid_amount }}</span>
                                                        </p>
                                            ...
                                            @foreach ($instructors as $instructor)
                                                @if ($instructor->status == 0)
                                                    <div class="col-md-2 col-2">
                                                        <img src="{{ asset('images/instructor/' . $instructor['image']) }}"
                                                            alt="user " class="online img-cousre">
                                                    </div>
                                                    <div class="col-md-10 col-10">
                                                        <p><span
                                                                class="text-dark">{{ $instructor['fname'] }}&nbsp;{{ $instructor['lname'] }}</span><br>
                                                            <span>
                                                                {{ str_limit($instructor['detail'], $limit = 130, $end = '...') }}</span>
                                                        </p>
