...
class ApiController extends Controller
{
    ...
    public function setApiView()
    {
        ...
        $env_files = [
            ...
            'BUNNYCDN_LIBRARY_ID' => env('BUNNYCDN_LIBRARY_ID'),
            'BUNNYCDN_ZONE' => env('BUNNYCDN_ZONE'),
    ...
    public function changeEnvKeys(Request $request)
    {
        ...
        $addenv_keys = DotenvEditor::setKeys([
            ...
            'BUNNYCDN_LIBRARY_ID' => $input['BUNNYCDN_LIBRARY_ID'],
            'BUNNYCDN_HOSTNAME' => $input['BUNNYCDN_HOSTNAME'],
            'BUNNYCDN_ZONE' => $input['BUNNYCDN_ZONE'],
