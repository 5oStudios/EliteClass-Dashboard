    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                	...
                	<div class="card-body">
                   		<!-- form start -->
						<form id="demo-form2" method="post" action="{{route('lang.update',$language->id)}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
							{{ csrf_field() }}
							{{ method_field('PUT') }}
							...
							<div class="row">
								...
								<div class="form-group col-md-2">
									<label class="text-dark" for="exampleInputDetails">{{ __('adminstaticword.SetDefault') }} :</label><br>
