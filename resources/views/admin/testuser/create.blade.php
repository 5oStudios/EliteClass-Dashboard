...
@section('title', 'Create a test user')
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-tittle">{{ __('adminstaticword.Add') }} {{ __('adminstaticword.TestUser') }}</h5>
                </div>
                <div class="card-body">
                    <form autocomplete="off" action="{{ route('testuser.store') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="timezone" required>
                                        ...
                                        <option value="Europe/Berlin">Amsterdam, Berlin, Rome, Stockholm, Vienna
                                        </option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="phone" value="{{ old('full_phone') }}" required type="tel"
                                        min="0" name="mobile"
