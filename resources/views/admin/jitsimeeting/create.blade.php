                    ...
                    <form autocomplete="off" action="{{ route('jitsi.meeting.save') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div style="display: none" class="form-group col-md-9 update-password">
                                ...
                                <div class="indv-jits form-group col-md-3">
                                    <label>{{ __('adminstaticword.Category') }}:<span class="redstar">*</span></label>
                                    <select name="main_category" id="category_id" class="form-control select2" required>
                                ...
                                <div class="indv-jits form-group col-md-3">
                                    ...
                                    <select name="sub_category" id="upload_id" class="form-control select2" required>
                                    </select>
                                </div>
                                <div class="indv-jits form-group col-md-3">
                                    <label>{{ __('adminstaticword.ChildCategory') }}:<span class="redstar">*</span></label>
                                    <select name="ch_sub_category" id="grand" class="form-control select2" required></select>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="exampleInputTit1e">{{ __('adminstaticword.Instructor') }}:<span class="redstar">*</span></label>
                                    <select name="user_id" required class="form-control js-example-basic-single">
