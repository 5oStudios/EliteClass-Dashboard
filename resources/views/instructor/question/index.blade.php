...
<div class="col-md-5 col-lg-5">
  <div class="widgetbar">
    @can(['question.create', 'question.delete'])
      ...
      <div class="card m-b-30">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table id="ques-datatable" class="table table-striped table-bordered">
              <thead>
                <tr>
                  <th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {{ $que->status == '1' ? 'Active' : 'Not active' }}
