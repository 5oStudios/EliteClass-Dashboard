                        ...
                        <!-- <form action="{{ route('roles.update',$role->id) }}" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <table class="permissionTable table table-bordered">
                                    ...
                                    <th>
                                        <label>
                                            <input class="grand_selectall" type="checkbox" disabled>
                                            {{__('Select All') }}
                                        </label>
                                    </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="30%">
                                                <label>
                                                    <input class="selectall" type="checkbox" disabled>
                                                    {{__('Select All') }}
                                                </label>
                                            </td>
                                            <td>
                                                ...
                                                @forelse($group as $permission)
                                                    ...
                                                    <label>
                                                        <input {{ $role->permissions->contains('id',$permission->id) ? "checked" : "" }} class="permissioncheckbox" type="checkbox" value="{{ $permission->id }}" disabled>
                                                        {{$permission->name}} &nbsp;&nbsp;
                                                    </label>
