        ...
        <div class="card m-b-30">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label>{{ __('adminstaticword.Image') }}:<sup class="redstar text-danger">*</sup></label>
                  ...
                  <label class="control-label" for="first-name">{{ __('Image') }}<span
                      ...
                      <div class="input-group">
                        ...
                        <input required readonly id="image" name="image" type="text"
                            class="form-control">
                        <label class="custom-file-label" for="inputGroupFile01">{{ $cate->image?? __('Choose file') }}</label>
