  ...
  <div class="row">
    <div class="col-lg-12">
          ...
          <div class="row ">
			...
			<div class="form-group col-md-6">
			    ...
			    <div class="input-group mb-3">
					<input  min="1" class="form-control" name="instructor_revenue" type="number" value="{{ optional($setting)->instructor_revenue }}" id="revenue"  placeholder="Enter revenue percentage" class="{{ $errors->has('instructor_revenue') ? ' is-invalid' : '' }} form-control">
			...
			<label for="Revenue">{{ __('Admin Revenue') }}:</label>
			    <div class="input-group mb-3">
					<input min="1" class="form-control" name="admin_revenue" type="number" value="{{ 100 - optional($setting)->instructor_revenue }}" id="revenue"  placeholder="Enter revenue percentage" class="{{ $errors->has('admin_revenue') ? ' is-invalid' : '' }} form-control" readonly>
					<div class="input-group-prepend">
						<span class="input-group-text" id="basic-addon1">%</span>
					</div>
				</div>
      ...
      <div class="form-group col-md-4">
            	<label for="">{{ __('adminstaticword.PaytmEnable') }}: </label><br>
            ...
            <div class="form-group col-md-4">
				<label for="">{{ __('adminstaticword.PaypalEnable') }}: </label><br>
            ...
            <div class="form-group col-md-4">
				<label for="">{{ __('adminstaticword.BankTransferEnable') }}: </label><br>
