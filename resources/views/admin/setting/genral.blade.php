<form id="settingsform" class="form" action="{{ route('setting.store') }}" method="POST" novalidate
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-dark">{{ __('adminstaticword.ProjectTitle') }} :<sup
                        class="text-danger">*</sup><small class="text-muted"> <i class="feather icon-help-circle"></i>
                        {{ __('readonly') }}</small></label>
                <input name="" autofocus="" type="text" class="form-control"
                    placeholder="Enter project title" value="{{ $setting->project_title }}" readonly>
            </div>
        </div>
        <!-- ============ Project Title end =========================-->
        <!-- ============ APP URL start =============================-->
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-dark">{{ __('adminstaticword.APPURL') }} :<sup class="text-danger">*</sup><small
                        class="text-muted">
                        <i class="feather icon-help-circle"></i>
                        {{ __('readonly') }}</small></label>
                <input name="" autofocus="" type="text" class="form-control" readonly
                    placeholder="http://localhost/" value="{{ $env_files['APP_URL'] }}">
            </div>
        </div>
        <!-- ============ APP URL end =============================-->
        <!-- ============ Contact start =============================-->
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-dark" for="phone">{{ __('adminstaticword.Contact') }} :<sup
                        class="text-danger">*</sup>
                    <small class="text-muted"> <i class="feather icon-help-circle"></i>
                        {{ __("For now, it's been used for customer support") }}</small></label>
                <input value="{{ $setting->default_phone }}" name="default_phone" placeholder="Enter contact no."
                    type="text" class="{{ $errors->has('default_phone') ? ' is-invalid' : '' }} form-control"
                    required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-dark" for="wel_email">{{ __('adminstaticword.Email') }} :<sup
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="text-dark" for="cpy_txt">{{ __('adminstaticword.CopyrightText') }} :<sup
                        class="text-danger">*</sup></label>
                <input value="{{ $setting->cpy_txt }}" name="cpy_txt" placeholder="Enter Copyright Text" type="text"
                    class="{{ $errors->has('cpy_txt') ? ' is-invalid' : '' }} form-control" required>
                <div class="invalid-feedback">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="default_address" rows="2" class="form-control" placeholder="Enter your address">
                    {{ $setting->default_address }}</textarea>
            </div>
        </div>
        <!-- ============ Address end =========-->
        <!-- ============ MapCoordinates start =========-->
        <div class="d-none bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            <h4 class="mt-3 mb-3"><i class="feather icon-settings" aria-hidden="true"></i> MapCoordinates Settings
            </h4>
            <div class="col-md-12">
                <div class="form-group">
            ...
            <!-- contact page start -->
            <div class="col-md-12">
                <div class="row" style="{{ $setting['map_enable'] == 'image' ? '' : 'display:none' }}"
                    id="sec_one">
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="inputGroupFile01"
                                    name="contact_image" aria-describedby="inputGroupFileAddon01">
            ...
            <!-- contact page end -->
            <div class="col-md-12">
                <div class="row" style="{{ $setting['map_enable'] == 'map' ? '' : 'display:none' }}"
                    id="sec1_one">
                    <div class="col-md-4">
                        <label class="text-dark" for="map_lat">{{ __('adminstaticword.MapLatitude') }}:</label>
                        <input value="{{ $setting->map_lat }}" name="map_lat" placeholder="Enter Latitude"
                            type="text" class="{{ $errors->has('map_lat') ? ' is-invalid' : '' }} form-control">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input value="{{ $setting->map_api }}" name="map_api" placeholder="Enter Map Api"
                            type="text" class="{{ $errors->has('map_api') ? ' is-invalid' : '' }} form-control">
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch10"
                            id="customSwitch10">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch11"
                            id="customSwitch11">
                        <div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch12"
                            id="customSwitch12">
                    </div>
                </div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch13"
                            id="customSwitch13">
                        <div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch14"
                            id="customSwitch14">
                        <div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch15"
                            id="customSwitch15">
                        <div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch16"
                            id="customSwitch16">
                        <div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch17"
                            id="customSwitch17">
                        <div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch18"
                            id="customSwitch18">
                        <div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch19"
                            id="customSwitch19">
                        <div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark">{{ __('Login with Email') }} :</label><br>
                        <input type="checkbox" class="custom_toggle" id="emailstatus" name="login_email"
                            {{ $gsetting->login_email == 1 ? 'checked' : '' }} />

                        <div>
                            <small>{{ __('(Enable Users Login with Email)') }}</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark">{{ __('Login with Mobile') }} :</label><br>
                        <input type="checkbox" class="custom_toggle" id="mobilestatus" name="login_mobile"
                            {{ $gsetting->login_mobile == 1 ? 'checked' : '' }} />
                        <div>
                            <small>{{ __('(Enable Users Login with Mobile No.)') }}</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch20"
                            id="customSwitch20">
                        <div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch21"
                            id="customSwitch21">
                        <div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch22"
                            id="customSwitch22">
                        <div>
                            <small>{{ __('(Enable Ip block on portal)') }}</small>
                        </div>
            ...
            <div class="d-none row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch23"
                            id="customSwitch23">
                        <div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch24"
                            id="customSwitch24">
                        <div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch25"
                            id="customSwitch25">
                        <div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch26"
                            id="customSwitch26">
                        <div>
        ...
        <div class="bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            <h4 class="mt-3 mb-3"><i class="feather icon-loader" aria-hidden="true"></i> Live Streaming Settings
            </h4>
            ...
            <div class="row">
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch27"
                            id="customSwitch27">
                        <div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="text-dark">{{ __('Enable Big Blue') }} : </label><br>
                        <input type="checkbox" class="custom_toggle" id="customSwitch28" name="bbl_enable"
                            {{ $gsetting->bbl_enable == 1 ? 'checked' : '' }} />
                        <input type="hidden" name="free" value="0" for="customSwitch28"
                            id="customSwitch28">
                        <div>
                            <small>{{ __('(Enable Big Blue live streaming on portal)') }}</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch29"
                            id="customSwitch29">
                        <div>
                ...
                <div class="d-none col-md-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="free" value="0" for="customSwitch30"
                            id="customSwitch30">
                        <div>
        ...
        <div class="d-none bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            <h4 class="mt-3 mb-3"><i class="feather icon-toggle-right" aria-hidden="true"></i>
                {{ __('Slider On/Off') }}
            </h4>
                    ...
                    <div class="form-group">
                        ...
                        <label class="switch">
                            <input type="checkbox" class="custom_toggle"
                                id="customSwitch51"{{ env('PRICE_DISPLAY_FORMAT') == 'comma' ? 'checked' : '' }}
                                name="PRICE_DISPLAY_FORMAT">
                        </label>
                        <br>
                        <small class="text-muted"><i class="fa fa-question-circle"></i> By toggling it price will
                            display on front end with comma eg : 1000.12 will show <b>1 000,50</b>.</small>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                    ...
                    <div style="{{ $gsetting->watch_enable == 1 ? '' : 'display: none' }}" id="update-password">
                        <div class="form-group">
                            ...
                            <input type="number" name="watch_time" value="{{ $gsetting->watch_time }}"
                                class="form-control"
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="input-group">
                        ...
                        <input required readonly id="image" for="logo" name="logo" type="text"
                            class="form-control">
            ...
            <div class="row mb-4">
                <div class="col-md-9">
                    ...
                    <div class="input-group">
                        ...
                        <input required readonly id="footer_logo" for="footer_logo" name="footer_logo"
        ...
        <div class="form-group col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-3 p-3 bg-primary-rgba">
                    <img src="{{ url('/images/logo/' . $setting->preloader_logo) }}" class="img-fluid" />
                </div>
