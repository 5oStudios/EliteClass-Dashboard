        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body ml-2">
                    <form autocomplete="off" action="{{ route('alluser.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="institute" class="form-control select2" name="institute">
                                        ...
                                        <option value="{{ $institute->slug }}" {{ $user->institute == $institute->slug ? 'selected' : '' }}>{{ $institute->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="major" class="form-control select2" name="major">
                                        ...
                                        <option value="{{ $major->slug }}" {{ $user->major == $major->slug ? 'selected' : '' }}>{{ $major->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
