                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                      ...
                      <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delette{{ $que->id}}">
                  ...
                  <div class="modal fade bd-example-modal-sm" id="delette{{$que->id}}" tabindex="-1" role="dialog"
                    aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        <div class="modal-header">
      ...
      <div class="modal-content">
        ...
        <div class="box box-primary">
          <div class="panel panel-sum">
            <div class="modal-body">
              <form autocomplete="off" id="demo-form2" method="post" action="{{ route('questionanswer.store') }}" data-parsley-validate
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <textarea name="question" onkeyup="countChar(this)" rows="5" class="form-control"
                      placeholder="{{__('Enter Your Question')}}" maxlength="300" autofocus required></textarea>
