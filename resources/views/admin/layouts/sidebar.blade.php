                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel"
                        ...
                        <ul class="vertical-menu">
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li
                                        ...
                                        <ul class="vertical-submenu">
                                            ...
                                            <li class="{{ Nav::isResource('typecategory') }}"><a
                                                    href="{{url('typecategory')}}">{{ __('adminstaticword.TypeCategory') }}</a>
                                            </li>
                            ...
                            <li
                                class="{{ Nav::isRoute('save.affiliates') }} {{ Nav::isRoute('wallet.settings') }} {{ Nav::isRoute('transactions') }}">
                                <a href="javaScript:void();">
                                    <i
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isRoute('wallet.settings') }} {{ Nav::isRoute('transactions') }}">
                                        <a href="javaScript:void();">
                                    ...
                                    @endcan  
                                        ...
                                        <ul class="vertical-submenu">
                                            ...
                                            <li class="{{ Nav::isRoute('transactions') }}"><a
                                                    href="{{route('transactions')}}">{{ __('adminstaticword.Wallet') }}
