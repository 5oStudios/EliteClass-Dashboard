    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form autocomplete="off" action="{{ route('allinstructor.store') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('fname') }}" autofocus required name="fname" type="text" class="form-control" placeholder="{{ __('adminstaticword.Please') }} {{ __('adminstaticword.Enter') }} {{ __('adminstaticword.FirstName') }}" />
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="phone" value="{{ old('full_phone')}}" type="tel" name="mobile" min="0"
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="short_info" name="short_info" rows="3" class="form-control"
                                      placeholder="{{ __('adminstaticword.Please') }} {{ __('adminstaticword.Enter') }} {{ __('adminstaticword.ShortInfo') }}" required></textarea>
                        </div>
                        <div class="form-group">
