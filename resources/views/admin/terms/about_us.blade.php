    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="card-box">{{ __('About Us') }}</h5>
                        </div>
                        <!-- language start -->
                        @php
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="text-dark">{{ __('adminstaticword.AboutUs') }} : <span class="text-danger">*</span></label>
                                                            <textarea id="detail" name="about_us" required="">{{ optional($items)->about_us }}</textarea>
                                                        </div>
                                                    </div>
