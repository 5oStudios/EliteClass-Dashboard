...
@section('title', __('Create bulk coupons'))
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-box">{{ __('adminstaticword.Add') }} {{ __('Bulk') }} {{ __('Coupons') }}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('coupon.bulk.store') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="text-dark">{{ __('Coupon Category') }}: <span
                                            class="text-danger">*</span></label>
                                    <select required name="coupon_category" id="coupon_category"
                                        class="form-control select2">
                                        <option value="" selected disabled hidden>
                                            {{ __('adminstaticword.SelectanOption') }}
                                        </option>
                                        <option value="random">{{ __('Random coupons') }}</option>
                                        <option value="increment"> {{ __('Increment coupons') }}</option>
                                    </select>
                                </div>

                                <div id="couponCodebox" class="col-md-6 form-group" style="display: none;">
                                    <label class="text-dark">{{ __('adminstaticword.CouponCode') }}: <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="couponcode" name="code">
                                </div>

                                <div id="couponCountbox" class="col-md-6 form-group">
                                    <label class="text-dark">{{ __('adminstaticword.NumberOfCoupons') }}: <span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control" min="1" name="coupon_count">
                                </div>
    ...
    <script>
        (function($) {
            ...
            $('#coupon_category').on('change', function() {
                ...
                $('#couponcode').attr('required', false);
                $('#couponCodebox').hide();
                $('#couponcode').val('');

                if ($(this).val() === 'increment') {
                    $('#couponCodebox').show();
                    $('#couponcode').attr('required', true);
                }
            });
