...
<a href="{{url('course/create/'. $jp->courses->id)}}" class="float-right btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i>{{ __('Back') }}</a>
</div>
@endslot
@endcomponent
          ...
          <form id="demo-form" method="post" action="{{url('reviewrating/'.$jp->id)}}"data-parsley-validate class="form-horizontal form-label-left">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <select name="course" class="form-control select2 col-md-7 col-xs-12">
