    ...
    <div class="modal-content">
      ...
      <div class="box box-primary">
        <div class="panel panel-sum">
          <div class="modal-body">
            <form autocomplete="off" id="demo-form2" method="post" action="{{ route('whatlearns.store') }}" data-parsley-validate
              ...
              <div class="row">
                <div class="col-md-10">
                  ...
                  <textarea rows="2" name="detail" class="form-control" placeholder="{{__('Enter Your Detail')}}" required></textarea>
                </div>
                <br>
                <br>
                <div class="col-md-2">
