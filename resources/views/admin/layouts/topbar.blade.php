...
<div class="topbar">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-12 align-self-center">
            <div class="togglebar" style="display:none;">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                    ...
                                    <div class="userbox">
                                        <ul class="list-unstyled mb-0">
                                            <li class="media dropdown-item">
                                                <a href="{{ url('user/edit/profile/' . Auth()->User()->id) }}"
                                                    class="profile-icon"><img
                                                        src="{{ url('admin_assets/assets/images/svg-icon/crm.svg') }}"
                                                        class="img-fluid" alt="user">{{ __('My Profile') }}</a>
                                            </li>
                                            ...
                                            @else
                                                <li class="media dropdown-item">
                                                    <a href="{{ route('logout') }}" class="profile-icon"
                                                        ...
                                                        <img src="{{ url('admin_assets/assets/images/svg-icon/logout.svg') }}"
                                                            class="img-fluid" alt="logout">{{ __('Logout') }}</a>
